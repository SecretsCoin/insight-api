...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\DogeCoinDark\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/DogeCoinDark/';
  if (isLinux) dataDir = process.env.HOME + '/.DogeCoinDark/';
}
